  ...
  return (
    <Card>
      ...
      <CardHeader className="text-center">
        {" "}
        <CardTitle className="text-xl">Welcome</CardTitle> <CardDescription>Login to access all features</CardDescription>{" "}
      </CardHeader>{" "}
      <CardContent>
        {" "}
        <form onSubmit={onSubmit} className="space-y-4">
          {" "}
          <FormInput form={form} name="email" label="Email" placeholder="Insert email here" type="email" /> <FormInput form={form} name="password" label="Password" placeholder="******" type="password" />{" "}
